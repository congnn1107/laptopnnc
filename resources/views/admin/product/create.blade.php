        ...
        <form action="{{route('product.store')}}" enctype="multipart/form-data" method="post">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="memory" id="" placeholder="Ví dụ: 2 Khe ram DDR4 3200MHz..." class="form-control" value="{{old('memory')}}">
                            @error('memory')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" placeholder="Ví dụ: 4GB | 8GB" name="memory_capacity" id="txtMemCap" class="form-control" value="{{old('memory_capacity')}}">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" placeholder="Có hoặc bỏ trống.." name="ssd_storage" id="txtSSD" value="{{old('ssd_storage')}}" class="form-control">
                            @error('ssd_storage')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Ví dụ: HD 720p..." id="txtCaseMaterial" class="form-control" name="webcam" value="{{old('webcam')}}">
                        @error('webcam')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" placeholder="Ví dụ: 2xUSB 3.2, 1xCombo audio/microphone jacket" name="connection_port" id="txtConnect" class="form-control" value="{{old('connection_port')}}">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <input type="text" name="size" id="" class="form-control" placeholder="Dài x Rộng x Dày" value="{{old('size')}}">
                    @error('size')
                        <p class="text-danger">{{$message}}</p>
                    @enderror
                </div>
                <div class="col-md-4">
                    ...
                    <input type="text" name="weight" id="" class="form-control" placeholder="Ví dụ: 1.1 KG" value="{{old('weight')}}">
                    @error('weight')
                        <p class="text-danger">{{$message}}</p>
                    @enderror
                </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <input type="text" name="package" id="" class="form-control" placeholder="Ví dụ: Thân máy, dây nguồn..." value="{{old('package')}}">
                    @error('package')
                        <p class="text-danger">{{$message}}</p>
                    @enderror
                </div>
                <div class="col-md-4">
                    ...
                    <input type="text" name="warranty_time" id="" class="form-control" placeholder="Ví dụ: 12 tháng" value="{{old('warranty_time')}}">
                    @error('warranty_time')
                        <p class="text-danger">{{$message}}</p>
                    @enderror
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="stock" id="" class="form-control" value="{{ old('stock') }}">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
