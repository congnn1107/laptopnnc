                    ...
                    <div class="item">
                        <div class="title">
                            <a href="#clear" data-action="open" class="down"> <i
                                    class="ion-android-arrow-dropdown"></i> Open</a>
                        ...
                        @foreach ($products as $item)
                            <div class="col-sm-6 col-md-4 product">
                                <div class="body">
                                    ...
                                    <div class="content">
                                        <h1 class="h3" style="overflow: hidden;
                                        text-overflow: ellipsis;
                                        display: -webkit-box;
                                        -webkit-line-clamp: 2; /* number of lines to show */
                                                line-clamp: 2; 
                                        -webkit-box-orient: vertical;" title="{{ $item->name }}">{{ $item->name }}</h1>
                                        <p class="price">{{ number_format($item->sell_price,0,',','.') }}đ</p>
                                        {{-- <label>Desktop</label> --}}
